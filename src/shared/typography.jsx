...
export const H1 = ({ children }) => {
  return <h1 className="heading heading-1">{children}</h1>;
};

export const H2 = ({ children }) => {
  return <h2 className="heading heading-2">{children}</h2>;
};

export const H3 = ({ children }) => {
  return <h3 className="heading heading-3">{children}</h3>;
};
...
export const H5 = ({ children }) => {
  return <h5 className="heading heading-5">{children}</h5>;
};
